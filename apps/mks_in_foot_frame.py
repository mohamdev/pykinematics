...
insole_pose = get_insoleR_pose(mocap_mks_list[0])
...
# write_markers_to_csv(mocap_mks_list, "./data/mocap_data/"+ trial +"/Lowerbody_Cal_test.csv" )

write_markers_to_csv(mocap_mks_list, "./data/mocap_data/"+ trial +"/Lowerbody_Cal_insole.csv" )