...
def augmentTRC(pathInputTRCFile, subject_mass, subject_height,
    ...
    if augmenter_model == 'v0.0':
        from utils.utils import getOpenPoseMarkers_fullBody
        ...
        from utils.utils import getOpenPoseMarkers_lowerExtremity
        ...
        from utils.utils import getMarkers_upperExtremity_noPelvis
